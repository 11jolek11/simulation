...
class Dice:
    ...
    def roll_dice(self, n: int = 30):
        for _ in range(n):
            self.first_points.append( self.generator.uniform_int(1, 6) +  self.generator.uniform_int(1, 6))
            self.second_points.append( self.generator.uniform_int(1, 6) +  self.generator.uniform_int(1, 6))
